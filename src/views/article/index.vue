  ...
  <div class="article-container">
    ...
    <div class="main-wrap">
      ...
      <div class="error-wrap" v-else>
        ...
        <van-button class="retry-btn" @click="getloadArticlebyId"
          >点击重试</van-button
        >
      </div>
      <!-- /加载失败：其它未知错误（例如网络原因或服务端异常） -->
...
export default {
  ...
  watch: {},
  created() {
    this.getloadArticlebyId();
  },
  mounted() {},
  methods: {
    async getloadArticlebyId() {
      this.loading = true;
      try {
        ...
        //   this.previewImage()      //这边为什么获取不到dom
        // })
      } catch (err) {
    ...
    previewImage() {
      const imgs = this.$refs["article-img"].querySelectorAll("img");
      const images = [];
